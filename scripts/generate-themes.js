...
Promise.all(tasks).then((res) => {
  ...
  var themeDarkFile =  path.resolve(__dirname, '../dist/styles/theme-dark.css')
  fs.copy(
  ...
  var themeDefaultFile =  path.resolve(__dirname, '../dist/styles/theme-default.css')
  fs.copy(
  ...
  var themeJmappFile =  path.resolve(__dirname, '../dist/styles/theme-jmapp.css')
  fs.copy(
